...
class LanguageState {
  ...
  LanguageState({required this.locale, required this.fontFamily});
}
...
class LanguageBloc extends Bloc<LanguageEvent, LanguageState> {
  LanguageBloc()
    : super(
        LanguageState(locale: const Locale('en'), fontFamily: poppinsRegular),
      ) {
    _loadLanguage();
    ...
    on<ChangeLanguage>((event, emit) async {
      ...
      emit(LanguageState(locale: locale, fontFamily: fontFamily));
    });
  }
  ...
  Future<void> _loadLanguage() async {
    ...
    emit(LanguageState(locale: Locale(languageCode), fontFamily: fontFamily));
  }
}
