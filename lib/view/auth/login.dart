      ...
      child: BlocConsumer<LoginCubit, LoginStates>(
        listener: (context, state) {
          ...
          if (state is LoginErrorState) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  "${DemoLocalization.of(context)!.getTranslatedValue('makeSureInfo')}",
                  style: TextStyle(
        ...
        builder: (context, state) =>
          ...
          return SafeArea(
            child: Scaffold(
              key: scaffoldKey,
              body: loadingStates == LoadingStates.loadingPage
                  ? Center(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          TextButton(
                                            ...
                                            child: Text(
                                              "${DemoLocalization.of(context)!.getTranslatedValue('forgetPass')}",
                                              style: TextStyle(
                                                color: state.color,
                                                fontFamily: CacheHelper.getData(
                                                            key:
