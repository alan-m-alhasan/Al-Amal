                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "${AppLocalization.of(context)?.getTranslatedValue('about_header')}",
                                style: TextStyle(
                                  color: state.color,
                                  fontSize:
                                      CacheHelper.getData(
                          ...
                          Text(
                            "${AppLocalization.of(context)?.getTranslatedValue('about_content')}",
                            style: TextStyle(
                              fontSize:
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 10.0),
                              Text(
                                "${AppLocalization.of(context)?.getTranslatedValue('our_mission_header')}",
                                style: TextStyle(
                                  color: state.color,
                                  fontSize:
                                      CacheHelper.getData(
                          ...
                          const SizedBox(height: 10.0),
                          Text(
                            "${AppLocalization.of(context)?.getTranslatedValue('our_mission_content')}",
                            style: TextStyle(
                              fontSize:
                                  CacheHelper.getData(key: 'languageCode') ==
                                          'en'
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 10.0),
                              Text(
                                "${AppLocalization.of(context)?.getTranslatedValue('our_vision_header')}",
                                style: TextStyle(
                                  color: state.color,
                                  fontSize:
                                      CacheHelper.getData(
                          ...
                          const SizedBox(height: 10.0),
                          Text(
                            "${AppLocalization.of(context)?.getTranslatedValue('our_vision_content')}",
                            style: TextStyle(
                              fontSize:
                                  CacheHelper.getData(key: 'languageCode') ==
                                          'en'
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 10.0),
                              Text(
                                "${AppLocalization.of(context)?.getTranslatedValue('why_alamal_header')}",
                                style: TextStyle(
                                  color: state.color,
                                  fontSize:
                                      CacheHelper.getData(
                          ...
                          const SizedBox(height: 10.0),
                          Text(
                            "${AppLocalization.of(context)?.getTranslatedValue('why_alamal_content')}",
                            style: TextStyle(
                              fontSize:
                                  CacheHelper.getData(key: 'languageCode') ==
                                          'en'
                          ...
                          // About Footer
                          Text(
                            "${AppLocalization.of(context)?.getTranslatedValue('about_footer')}",
                            style: TextStyle(
                              fontSize:
                                  CacheHelper.getData(key: 'languageCode') ==
                                          'en'
