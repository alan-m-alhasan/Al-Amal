                            ...
                            child: Column(
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Text(
                                    "${AppLocalization.of(context)!.getTranslatedValue('writeAdv')}",
                                    style: TextStyle(
                                      fontSize: 22.0,
                                      fontFamily:
                                          CacheHelper.getData(
                                ...
                                Form(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText:
                                          "${AppLocalization.of(context)!.getTranslatedValue('hintOfConsultMsg')}",
                                      ...
                                      label: Container(
                                        ...
                                        child: Directionality(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                "${AppLocalization.of(context)!.getTranslatedValue('send')}",
                                                style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 20.0,
                                                  fontFamily:
