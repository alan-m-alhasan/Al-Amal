...
class ConsultationThanks extends StatelessWidget {
  const ConsultationThanks({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${DemoLocalization.of(context)!.getTranslatedValue('doneAdvSend')}",
