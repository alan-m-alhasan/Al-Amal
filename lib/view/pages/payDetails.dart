      ...
      return SafeArea(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leadingWidth: 65.0,
            title: Text(
              "${DemoLocalization.of(context)!.getTranslatedValue('payDetails')}",
                ...
                child: Column(
                  children: [
                    ...
                    Align(
                      ...
                      child: Text(
                        "${DemoLocalization.of(context)!.getTranslatedValue('enterPayDetails')}",
                        style: TextStyle(
                            fontSize: 22.0,
                            fontFamily:
                      ...
                      child: Column(
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                "${DemoLocalization.of(context)?.getTranslatedValue('full_name')}",
                                style: const TextStyle(
                                  fontSize: 18.0,
                                ),
                              ),
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                "${DemoLocalization.of(context)?.getTranslatedValue('card_num')}",
                                style: const TextStyle(
                                  fontSize: 18.0,
                                ),
                              ),
                            ...
                            children: [
                              Flexible(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "${DemoLocalization.of(context)?.getTranslatedValue('exp_date')}",
                                      style: const TextStyle(
                                        fontSize: 18.0,
                                      ),
                                    ),
                              ...
                              Flexible(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "${DemoLocalization.of(context)?.getTranslatedValue('cvv')}",
                                      style: const TextStyle(
                                        fontSize: 18.0,
                                      ),
                                    ),
