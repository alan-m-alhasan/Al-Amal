            ...
            return SafeArea(
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leadingWidth: 65.0,
                  title: Text(
                    "${AppLocalization.of(context)!.getTranslatedValue('payMethod')}",
                    ...
                    child: Column(
                      children: [
                        ...
                        Align(
                          ...
                          child: Text(
                            "${AppLocalization.of(context)!.getTranslatedValue('choosePayMethod')}",
                            style: TextStyle(
                              fontSize: 22.0,
                              fontFamily:
                        ...
                        HorizontalSlidableButton(
                          ...
                          onChanged: (slide) {
                            if (paymentMethod != PaymentMethod.nothing) {
                              push(context: context, page: const PayDetails());
                            } else {
                              CustomSnackBar(
                                context: context,
