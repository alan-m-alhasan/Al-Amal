  ...
  void initState() {
    ...
    db.getUsers().then((users) {
      ...
      name = TextEditingController(
        text: profileData[getUserIndex()]['userName'],
      );
      email = TextEditingController(
        text: profileData[getUserIndex()]['userEmail'],
      );
      password = TextEditingController(
        text: profileData[getUserIndex()]['userPassword'],
      );
      phone = TextEditingController(
        text: profileData[getUserIndex()]['userPhone'],
      );
                                                    ...
                                                    children: [
                                                      Text(
                                                        CacheHelper.getData(
                                                            ...
                                                            : "${AppLocalization.of(context)!.getTranslatedValue('doctor')}",
                                                        style: const TextStyle(
                                                          color: Colors.white,
                                                          fontSize: 20.0,
                                                        ),
                                              ...
                                              children: [
                                                ...
                                                enableEdit == false
                                                    ? Container(
                                                      ...
                                                      child: Text(
                                                        profileData[getUserIndex()]['userName'],
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: TextStyle(
                                                          fontSize: 22.0,
                                                ...
                                                ? Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Text(
                                                        profileData[getUserIndex()]['userEmail'],
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: TextStyle(
                                                          fontSize: 20.0,
                                                ...
                                                ? Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Text(
                                                        profileData[getUserIndex()]['userPhone'],
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: TextStyle(
                                                          fontSize: 22.0,
                                                ...
                                                ? Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Text(
                                                        profileData[getUserIndex()]['userAge'],
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: TextStyle(
                                                          fontSize: 22.0,
                                                      ...
                                                      Future.delayed(
                                                        ...
                                                        () {
                                                          UsersAuth().userUpdate(
                                                            userId:
                                                                profileData[getUserIndex()]['userId'],
                                                            accountType:
                                                                profileData[getUserIndex()]['accountType'],
                                                            userName: name.text,
                                                            userPassword:
                                                                password.text,
                                                            userEmail:
