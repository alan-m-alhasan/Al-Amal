                          ...
                          child: Column(
                            children: [
                              ...
                              MaterialButton(
                                ...
                                child: ListTile(
                                  title: Text(
                                    "${AppLocalization.of(context)?.getTranslatedValue('change_palette')}",
                                    style: TextStyle(
                                      fontSize: 19.0,
                                      fontFamily:
                                          CacheHelper.getData(
                              ...
                              MaterialButton(
                                ...
                                child: ListTile(
                                  title: Text(
                                    "${AppLocalization.of(context)?.getTranslatedValue('startup_tone')}",
                                    style: TextStyle(
                                      fontSize: 19.0,
                                      fontFamily:
                                          CacheHelper.getData(
                                  ...
                                  trailing: SizedBox(
                                    ...
                                    child: FlutterSwitch(
                                      ...
                                      inactiveColor: state.color.withOpacity(
                                        0.3,
                                      ),
                              ...
                              if (CacheHelper.getData(key: 'accountType') !=
                                  'doctor')
                                const Divider(
                                  color: Colors.black45,
                                  indent: 26.0,
                              ...
                              Padding(
                                ...
                                child: Align(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    width:
                                        isExpanded ? fullWidth(context) : 70.0,
                                    child:
                                        isExpanded
                                            ? Column(
                                              crossAxisAlignment:
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Flexible(
                                                          child: Text(
                                                            "${AppLocalization.of(context)?.getTranslatedValue('del_account')}",
                                                            overflow:
                                                                TextOverflow
                                                                    .ellipsis,
                                                            maxLines: 1,
