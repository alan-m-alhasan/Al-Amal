                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              "${DemoLocalization.of(context)!.getTranslatedValue('verifiedEmail')}",
                              style: TextStyle(
                                  fontSize: 30.0,
                            ...
                            Flex(
                              ...
                              children: [
                                Text(
                                  "${DemoLocalization.of(context)!.getTranslatedValue('enterCodeSentEmail')}",
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              "${DemoLocalization.of(context)!.getTranslatedValue('noCodeArrived')}",
                              style: const TextStyle(
                                fontSize: 16.0,
                                color: Colors.grey,
                              ),
                            ...
                            TextButton(
                              ...
                              onPressed: () {},
                              child: Text(
                                "${DemoLocalization.of(context)!.getTranslatedValue('resend')}",
                                style: const TextStyle(
                                  fontSize: 16.0,
                                ),
                              ),
                        ...
                        if (state is! LoginLoadingState)
                          CustomButton(
                            ...
                            hasBorder: pinCon.text.length == 5 ? true : false,
                            context: context,
                            onPressed: pinCon.text.length == 5
                                ? () {
