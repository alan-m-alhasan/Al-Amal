    ...
    if (name.text.isNotEmpty &&
      ...
      if (_certificate != null &&
        ...
        if (isAgree == true) {
          ...
          CustomSnackBar(
            context: context,
            translateKey: 'plzAgreePrivacyPolicy',
          );
        }
      } else {
        CustomSnackBar(
          context: context,
          translateKey: 'upload_required_pictures',
        );
      }
    } else {
  ...
  void initState() {
    db.getUsers().then((users) {
      ...
      name = TextEditingController(
        text: accountsData[getUserIndex()]['userName'],
      );
      email = TextEditingController(
            ...
            return SafeArea(
              child: Scaffold(
                appBar: AppBar(
                  ...
                  leadingWidth: 65.0,
                  title: Text(
                    "${AppLocalization.of(context)!.getTranslatedValue('account_verify')}",
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          accountsData[getUserIndex()]['userEmail'],
                                    ),
                                  ),
                                  const SizedBox(height: 10.0),
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          accountsData[getUserIndex()]['userPhone'],
                                    ),
                                  ),
                                  const SizedBox(height: 10.0),
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(
                                        color: Colors.grey,
                                        fontFamily: checkTextFont(
                                          "${AppLocalization.of(context)!.getTranslatedValue('country')}",
                                        ),
                                      ),
                                      hintText:
                                          "${AppLocalization.of(context)!.getTranslatedValue('country')}",
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(
                                        color: Colors.grey,
                                        fontFamily: checkTextFont(
                                          "${AppLocalization.of(context)!.getTranslatedValue('medical_special')}",
                                        ),
                                      ),
                                      hintText:
                                          "${AppLocalization.of(context)!.getTranslatedValue('medical_special')}",
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(
                                        color: Colors.grey,
                                        fontFamily: checkTextFont(
                                          "${AppLocalization.of(context)!.getTranslatedValue('academic_deg')}",
                                        ),
                                      ),
                                      hintText:
                                          "${AppLocalization.of(context)!.getTranslatedValue('academic_deg')}",
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(
                                        color: Colors.grey,
                                        fontFamily: checkTextFont(
                                          "${AppLocalization.of(context)!.getTranslatedValue('medical_lice_num')}",
                                        ),
                                      ),
                                      hintText:
                                          "${AppLocalization.of(context)!.getTranslatedValue('medical_lice_num')}",
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(
                                        color: Colors.grey,
                                        fontFamily: checkTextFont(
                                          "${AppLocalization.of(context)!.getTranslatedValue('lice_auth')}",
                                        ),
                                      ),
                                      hintText:
                                          "${AppLocalization.of(context)!.getTranslatedValue('lice_auth')}",
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintStyle: TextStyle(
                                        color: Colors.grey,
                                        fontFamily: checkTextFont(
                                          "${AppLocalization.of(context)!.getTranslatedValue('workplace')}",
                                        ),
                                      ),
                                      hintText:
                                          "${AppLocalization.of(context)!.getTranslatedValue('workplace')}",
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          "${AppLocalization.of(context)!.getTranslatedValue('agree_privacy_policy')}",
                                        ),
                                      ),
                                    ],
                                  ),
